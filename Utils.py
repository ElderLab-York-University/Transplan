...
def check_config(args):
    ...
    # create Results folders Accordingly
    # check if Results folder is in the dataset location
    ...
    # Create each directory, ignore if it already exists
