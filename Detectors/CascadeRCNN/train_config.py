_base_ = './../MMDet/mmdetection/configs/cascade_rcnn/cascade-rcnn_x101-64x4d_fpn_1x_coco.py'
#CHANGE#BELOW#
...
#CHANGE#ABOVE#
load_from = "https://download.openmmlab.com/mmdetection/v2.0/cascade_rcnn/cascade_rcnn_x101_64x4d_fpn_1x_coco/cascade_rcnn_x101_64x4d_fpn_1x_coco_20200515_075702-43ce6a30.pth"
...
model = dict(
    ...
    backbone=dict(
        ...
        num_stages=4,
        out_indices=(0, 1, 2, 3),
        frozen_stages=4, # change to fine tune on more weights
