...
detectors = ["detectron2","InternImage", "YOLOv8"]
...
for src in (sources):
    ...
    for det in detectors:
        ...
        os.system(f"python3 main.py --Dataset={src}  --Detector={det} --Tracker=NULL   --Detect --VisDetect --DetPostProc --classes_to_keep 0 2 5 7")
    ...
    for det in detectors:
        for tra in trackers:
            ...
            os.system(f"python3 main.py --Dataset={src}  --Detector={det} --Tracker={tra} --VisTrack --Track")
