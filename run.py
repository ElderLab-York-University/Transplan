...
cached_split_part   = ["valid"]
cached_segment_part = ["Seg16"]
...
for src, cached_cnt_pth in zip(sources, cached_sources):
    ...
    #                         --MovesInROI --ROIFromTop --MoveInROITh=2")
